...
void lpc_acor(Shortword * restrict input, const Shortword * restrict win_cof,
			  Shortword * restrict autocorr, Shortword hf_correction, Shortword order,
			  Shortword npts)
{
...
Shortword lpc_bwex(Shortword * restrict lpc, Shortword * restrict aw, Shortword gamma,
				   Shortword order)
{
	register Shortword	i;
...
Shortword lpc_schr(Shortword * restrict autocorr, Shortword * restrict lpc, Shortword order)
{
	register Shortword	i, j;
...
Shortword lpc_pred2lsp(Shortword * restrict lpc, Shortword * restrict lsf, Shortword order)
{
	register Shortword	i;
...
#pragma MUST_ITERATE(5,5,)
	...
	/* for these indices.                                                     */
#pragma MUST_ITERATE(6,6,2)
#pragma UNROLL(2)
	for (i = 0; i <= p2; i++){
		p_cof[i] = my_round(L_p_cof[i]);                         /* p_cof in Q10 */
		q_cof[i] = my_round(L_q_cof[i]);                         /* q_cof in Q10 */
	}
...
Shortword	lpc_lsp2pred(Shortword * restrict lsf, Shortword * restrict lpc, Shortword order)
{
...
Shortword lpc_syn(Shortword * restrict x, Shortword * restrict y, Shortword * restrict a, Shortword order,
				  Shortword length)
{
	register Shortword	i, j;
	Longword	accum;
