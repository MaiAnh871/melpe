...
//	L_div = ((0x00008000L * (Longword) var1) / (Longword) var2);
	L_div = (((Longword) var1 << 15) / (Longword) var2);
//	swOut = saturate(L_div);
//	return(swOut);
	if (L_div > SW_MAX) 		return SW_MAX;
	else if (L_div < SW_MIN) 	return SW_MIN;
	else 						return (Shortword) L_div;
}
...
//Shortword my_round(Longword L_var1)
//{
//	Longword	L_Prod;
//	Shortword	var2;
//
...
//		} else {                                            /* negative input */
//			for (swShiftCnt = 0;
//				 !(L_var1 >= (Longword)LW_MIN && L_var1 < (Longword) 0xc0000000L);
//				 swShiftCnt++){
//				L_var1 = L_var1 << 1;
//			}
//		}
...
//	Shortword	swOut;
//
//	swOut = my_round(L_sub(L_var3, L_mult(var1, var2)));
//	return (swOut);
//}
