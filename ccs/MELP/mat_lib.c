...
void v_add(Shortword* restrict vec1, const Shortword* restrict vec2, Shortword n)
{
	register Shortword	i;
#pragma MUST_ITERATE(10,76,2)
#pragma UNROLL(2)
	for (i = 0; i < n; i++){
		*vec1 = add(*vec1, *vec2);
		vec1 ++;
...
Longword *L_v_add(Longword * restrict L_vec1, Longword * restrict L_vec2, Shortword n)
{
	register Shortword	i;
 ...
 *
 *************************************************************************/
void v_equ(Shortword  * restrict vec1, const Shortword * restrict vec2, Shortword n)
{
	register Shortword	i;
...
void v_equ_shr(Shortword * restrict vec1, Shortword * restrict vec2, Shortword scale, Shortword n)
{
	register Shortword	i;
#pragma MUST_ITERATE(2,321,)
	for (i = 0; i < n; i++){
		*vec1 = shr(*vec2, scale);
		vec1 ++;
		vec2 ++;
...
void L_v_equ(Longword * restrict L_vec1, Longword * restrict L_vec2, Shortword n)
{
	register Shortword	i;

#pragma MUST_ITERATE(2,10,)
	for (i = 0; i < n; i++){
		*L_vec1 = *L_vec2;
		L_vec1 ++;
		L_vec2 ++;
...
Longword L_v_inner(Shortword * restrict vec1, Shortword * restrict vec2, Shortword n,
				   Shortword qvec1, Shortword qvec2, Shortword qout)
{
	register Shortword	i;
	Shortword	shift;
...
Longword L_v_magsq(Shortword * restrict vec1, Shortword n, Shortword qvec1,
				   Shortword qout)
{
	register Shortword	i;
	Shortword	shift;
...
void v_scale(Shortword * restrict vec1, Shortword scale, Shortword n)
{
	register Shortword i;
	_amem2((void*) vec1);
...
void v_sub(Shortword *restrict vec1, const Shortword * restrict vec2, Shortword n)
{
	register Shortword	i;

#pragma MUST_ITERATE(2,20,2)
#pragma UNROLL(2)
	for (i = 0; i < n; i++){
		*vec1 = sub(*vec1, *vec2);
		vec1 ++;
 ...
 *
 *************************************************************************/
void v_zap(Shortword vec1[], Shortword n)
{
	register Shortword	i;
