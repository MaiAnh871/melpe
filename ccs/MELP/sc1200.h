...
typedef int				Longword;				/* 32 bit "accumulator" (L_*), sua kieu long int -> int */
typedef short			Shortword;				/* 16 bit "register" (sw*), sua kieu short int -> short */
typedef short			ShortwordRom;			/* 16 bit ROM data (sr*), sua kieu short int -> short */
typedef int				LongwordRom;			/* 32 bit ROM data (L_r*), sua kieu long int -> int */
typedef unsigned short	UShortword;				/* 16 bit unsigned data */
typedef unsigned long	ULongword;				/* 32 bit unsigned data */
typedef int40_t			Word40;					/* 40 bit "accumulator", sua kieu long double -> long */
/* ================== */
/* General Definition */
/* ================== */
