...
void bpvc_ana(Shortword * restrict speech, Shortword * restrict fpitch, Shortword * restrict bpvc,
			  Shortword *pitch)
{
...
void remove_dc(Shortword * restrict sigin, Shortword * restrict sigout, Shortword len)
{
...
Shortword gain_ana(Shortword sigin[], Shortword pitch, Shortword minlength, Shortword maxlength)
{
	Shortword	length;                                                 /* Q0 */
			   ...
			   Shortword down, Shortword min, Shortword max)
{
	...
	temp1 = my_round(L_temp);
	L_temp = L_shl(L_deposit_l(down), 7);
	L_temp = L_add(L_noise_gain, L_temp);
	temp2 = my_round(L_temp);
