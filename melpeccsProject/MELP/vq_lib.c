...
void vq_lspw(Shortword * restrict weight, Shortword * restrict lsp, Shortword * restrict lpc, Shortword order)
{
...
//			/* codebook value */
//			v_equ(&n_errors[c*order], &p_errors[n_parents[c]*order],
//						 order);
...
Longword vq_enc(const Shortword * restrict codebook, Shortword * restrict u, Shortword levels,
				Shortword order, Shortword * restrict u_hat, Shortword *indices)
{
	register Shortword	i, j;
