...
static Shortword	InsertCand(Shortword c1, Shortword s1, Shortword * restrict dMin,
							Shortword distortion, Shortword entry,
							Shortword * restrict nextIndex, Shortword * restrict index);
...
#pragma MUST_ITERATE(3,3,)
	...
	index = 0;
	temp2 = 0;
#pragma MUST_ITERATE(1024,1024,4)
#pragma UNROLL(4)
...
**
***********************************************************************/
static Shortword	WeightedMSE(Shortword n, Shortword * restrict weight,
				const Shortword * restrict x, Shortword * restrict target, Shortword max_dMin)
{
	register Shortword	i;
	Longword	distortion;
...
#pragma MUST_ITERATE(5,10,)
	...
	if (my_round(distortion) >= max_dMin)      /* if this situation takes place, */
...
**
***********************************************************************/
void deqnt_msvq(Shortword * restrict qout, const Shortword * restrict codebook, Shortword tos,
				const Shortword * restrict cb_size, Shortword * restrict index, Shortword dim)
{
	register Shortword	i;
