...
void envelope(Shortword * restrict input, Shortword prev_in, Shortword * restrict output,
			  Shortword npts)
{
...
/* ====================================================== */
void fill(Shortword * restrict output, Shortword fillval, Shortword npts)
{
	register Shortword	i;
#pragma MUST_ITERATE(2,129,)
	for (i = 0; i < npts; i++){
		output[i] = fillval;
	}
}
...
/* This function fills an input array with a given value. */
/* ====================================================== */
void L_fill(Longword * restrict output, Longword fillval, Shortword npts)
{
	register Shortword	i;

#pragma MUST_ITERATE(2,16,2)
#pragma UNROLL(2)
	for (i = 0; i < npts; i++){
		output[i] = fillval;
	}
...
void	interp_array(Shortword * restrict prev, Shortword * restrict curr, Shortword *restrict out,
...
void window(Shortword * restrict input, const Shortword * restrict win_coeff, Shortword * restrict output,
			Shortword npts)
{
	register Shortword	i;
#pragma MUST_ITERATE(200,256,4)
#pragma UNROLL(4)
	for (i = 0; i < npts; i++){
...
void window_Q(Shortword * restrict input, Shortword * restrict win_coeff, Shortword * restrict output,
...
void zerflt(Shortword * restrict input, const Shortword * restrict coeff, Shortword * restrict output,
			Shortword order, Shortword npts)
{
	register Shortword	i, j;
	Longword	accum;
...
/* ========================================================================== */
void iir_2nd_d(Shortword input[], const Shortword * restrict den, const Shortword * restrict num,
			   Shortword output[], Shortword * restrict delin, Shortword * restrict delout_hi,
			   Shortword * restrict delout_lo, Shortword npts)
{
	register Shortword	i;
	Shortword	temp;
	Longword	accum;

#pragma MUST_ITERATE(180,180,4)
#pragma UNROLL(4)
	for (i = 0; i < npts; i++){
