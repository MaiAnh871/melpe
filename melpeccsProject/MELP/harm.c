...
static void		realIDFT(Shortword * restrict mag, Shortword * restrict phase, Shortword * restrict signal, Shortword length);
...
**
*****************************************************************************/
void	harm_syn_pitch(Shortword * restrict amp, Shortword * restrict signal, Shortword fc, Shortword length)
{
	register Shortword	i;
