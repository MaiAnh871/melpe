...
static Shortword	zeroCrosCount(Shortword * restrict speech);
...
**
*****************************************************************************/
void classify(Shortword * restrict inbuf, classParam *classStat, Shortword * restrict autocorr)
{
