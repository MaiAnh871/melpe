...
function [rxBuff,ReOutputBit] = BPSKDemod8khz(rxData)
    ...
    rxBuff = [];
    ReOutputBit = [];
    while (pointer+6*25<length(rxData))
        [nuSampleProcessed, data2] = BPSKDemodulated8kHz(rxData,pointer);
